...
public:
     ...
     * @internal
     */
    static const UnChar DEFAULT_TIME_SEPARATOR = 0x003a;  // ':'

    /**
     * This alternate time separator is always recognized when parsing.
     * @internal
     */
    static const UnChar ALTERNATE_TIME_SEPARATOR = 0x002e;  // '.'
#endif  /* U_HIDE_INTERNAL_API */
     ...
     * @stable ICU 2.0
     */
    static const UnChar * U_EXPORT2 getPatternUChars(void);
...
private:
     ...
     */
    static UDateFormatField U_EXPORT2 getPatternCharIndex(UnChar c);
     ...
     */
    static UBool U_EXPORT2 isNumericPatternChar(UnChar c, int32_t count);
public:
#ifndef U_HIDE_INTERNAL_API
    /**
