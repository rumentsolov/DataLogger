...
private:
     ...
     */
    static const UnChar* findID(const UnicodeString& id);
     ...
     */
    static const UnChar* dereferOlsonLink(const UnicodeString& id);
     ...
     */
    static const UnChar* getRegion(const UnicodeString& id);
  ...
  public:
     ...
     * @internal
     */
    static const UnChar* getRegion(const UnicodeString& id, UErrorCode& status);
#endif  /* U_HIDE_INTERNAL_API */
