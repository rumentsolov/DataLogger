...
//void(*printPage)(intrusive_ptr<Aspose::Cells::Systems::Object> sender, intrusive_ptr<Aspose::Cells::Systems::Drawing::Printing::PrintPageEventArgs> ev);
namespace Aspose {
	namespace Cells {
		namespace Systems {
			namespace Drawing {
				namespace Printing {
					...
					public:
						...
						//class CellsPrinter;
						//typedef void(*printPage)(intrusive_ptr<Aspose::Cells::Systems::Object> sender, intrusive_ptr<Aspose::Cells::Systems::Drawing::Printing::PrintPageEventArgs> ev);
