	...
	namespace Cells {
		namespace OpenXML
		{
			...
			public:
				...
				int32_t GetCrc32(Aspose::Cells::Systems::IO::StreamPtr input);
				int32_t GetCrc32AndCopy(Aspose::Cells::Systems::IO::StreamPtr input, Aspose::Cells::Systems::IO::StreamPtr output);
