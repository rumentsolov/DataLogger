...
namespace Aspose {
	namespace Cells {
		namespace OpenXML
		{
			...
			public:
				ZipOutputStream(Aspose::Cells::Systems::IO::StreamPtr stream);
				ZipOutputStream(Aspose::Cells::Systems::IO::StreamPtr stream, bool leaveOpen);
				...
				Aspose::Cells::Systems::Text::EncodingPtr GetAlternateEncoding() { return _alternateEncoding; }
				Aspose::Cells::Systems::Text::EncodingPtr GetDefaultEncoding() { return Encoding::GetUTF8(); }
			...
			private:
				...
				Aspose::Cells::Systems::IO::StreamPtr			_outputStream;
				...
				Aspose::Cells::Systems::IO::StreamPtr				_encryptor;
				Aspose::Cells::Systems::IO::StreamPtr				_deflater;
